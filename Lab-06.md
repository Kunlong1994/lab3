...
### Editing the Code ###
To change how your chatbot behaves, you will need to edit the code. To edit the code files, you can use `nano` a command line text editor. [Here is a cheat sheet](https://github.com/FAR-Lab/Developing-and-Designing-Interactive-Devices/wiki/Command-Line-Cheat-Sheet-(for-non-programmers)) for editing on the command line.
