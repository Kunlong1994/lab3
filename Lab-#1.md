...
**_In this example we often use `ixe[00].local`. This ONLY works if you are connected locally. if you are connected remotely or through the device arm WiFi, please replace the addresses with the ones explained in [If your laptop is on eduroam or RedRover and your IxE is on DeviceFarm](if-your-laptop-is-on-eduroam-or-redrover-and-your-ixe-is-on-devicefarm)._**
